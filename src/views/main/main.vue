  ...
  <div>
    ...
    <section class="categories">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6 p-0" @click="womenCategory">
            <div class="categories__item categories__large__item set-bg-img1">
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 p-0" @click="menCategory">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 p-0" @click="kidCategory">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 p-0" @click="cosmeticCategory">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 p-0" @click="accessoryCategory">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8">
            <ul class="filter__controls">
              <li class="active" data-filter="*" @click="allCategory">All</li>
              <li data-filter=".women" @click="womenCategory">Women’s</li>
              <li data-filter=".men" @click="menCategory">Men’s</li>
              <li data-filter=".kid" @click="kidCategory">Kid’s</li>
              <li data-filter=".accessories" @click="accessoryCategory">Accessories</li>
              <li data-filter=".cosmetic" @click="cosmeticCategory">Cosmetics</li>
            </ul>
          </div>
        </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-2 col-md-4 col-sm-4 p-0">
            <div class="instagram__item set-bg-img7">
          ...
          <div class="col-lg-2 col-md-4 col-sm-4 p-0">
            <div class="instagram__item set-bg-img8">
              <div class="instagram__text">
                <i class="fa fa-instagram"></i>
                <a href="#">@ ashion_shop</a>
              </div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-4 p-0">
            <div class="instagram__item set-bg-img9">
              <div class="instagram__text">
                <i class="fa fa-instagram"></i>
                <a href="#">@ ashion_shop</a>
              </div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-4 p-0">
            <div class="instagram__item set-bg-img10">
              <div class="instagram__text">
                <i class="fa fa-instagram"></i>
                <a href="#">@ ashion_shop</a>
              </div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-4 p-0">
            <div class="instagram__item set-bg-img11">
              <div class="instagram__text">
                <i class="fa fa-instagram"></i>
                <a href="#">@ ashion_shop</a>
              </div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-4 p-0">
            <div class="instagram__item set-bg-img12">
              <div class="instagram__text">
                <i class="fa fa-instagram"></i>
                <a href="#">@ ashion_shop</a>
              </div>
